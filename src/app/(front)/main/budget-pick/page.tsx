    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <main className="flex-1 w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="w-full py-6 md:py-10 mb-8 border-b-[4px] border-black">
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-black text-center text-black uppercase tracking-tight">Budget Pick</h1>
          <p className="text-center text-black font-bold mt-4 max-w-2xl mx-auto border-2 border-black p-2 bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                ...
                {categories.map((cat, idx) => (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      />
                      <span className={`text-sm font-bold uppercase transition-colors group-hover:text-[#3b82f6] ${cat.name === "Budget Shopping" ? "text-black" : "text-black"}`}>
                        {cat.name}
                      </span>
                    </div>
                    <span className={`text-xs px-2 py-0.5 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] font-black ${cat.name === "Budget Shopping" ? "bg-[#3b82f6] text-white" : "bg-white text-black"}`}>
                      {cat.count}
                    </span>
                  </label>
                ))}
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
              <div className="text-xs text-black uppercase tracking-widest font-black border-2 border-black px-3 py-1.5 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] bg-white">
                ...
                <span className="text-[#3b82f6]">Budget Pick</span>
              </div>
