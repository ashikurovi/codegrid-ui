...
export default function AddBigSellProductPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center gap-4">
        <Link href="/dotadmin/big-sell" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50 flex items-center justify-center p-2 border bg-white shadow-sm dark:bg-gray-950 dark:border-gray-800 transition-colors">
        ...
        <h1 className="text-3xl font-bold tracking-tight">Add Flash Sale Product</h1>
      </div>
        ...
        <div className="flex-1 w-full border bg-white p-6 shadow-sm dark:bg-gray-950 dark:border-gray-800">
          <form className="flex flex-col gap-8">
            ...
            <div className="mt-4 flex gap-4">
              <button 
                type="button"
                onClick={() => router.push("/dotadmin/big-sell")}
          ...
          <div className="border bg-white p-6 shadow-sm dark:bg-gray-950 dark:border-gray-800">
            ...
            <div className="flex flex-col gap-4">
              ...
              {galleryImages.map((id, index) => (
                <div key={id} className="relative border-2 border-dashed border-gray-300 p-6 flex flex-col items-center justify-center bg-gray-50 hover:bg-gray-100 dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-800 transition-colors cursor-pointer rounded-sm text-center">
                  <Upload className="w-5 h-5 text-gray-400 mb-2" />
                  <p className="font-medium text-gray-600 dark:text-gray-300 text-sm">Upload Gallery Image</p>
                  {galleryImages.length > 1 && (
                    <button
                      type="button"
                      onClick={(e) => {
                        e.stopPropagation();
                        setGalleryImages(galleryImages.filter(imgId => imgId !== id));
                      }}
              ...
              <button 
                type="button"
                onClick={() => setGalleryImages([...galleryImages, Date.now()])}
                className="flex items-center justify-center gap-2 border-2 border-dashed border-blue-300 p-4 bg-blue-50/50 hover:bg-blue-50 dark:bg-blue-900/10 dark:border-blue-800/50 dark:hover:bg-blue-900/20 text-blue-600 dark:text-blue-400 transition-colors cursor-pointer rounded-sm font-medium text-sm"
              >
