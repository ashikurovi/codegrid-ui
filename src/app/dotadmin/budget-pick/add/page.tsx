...
import { createBudgetPick } from "../../../../api/buget-pickApi";
...
export default function AddBudgetPickPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createBudgetPick(newProduct);
      router.push("/dotadmin/budget-pick");
    } catch (error) {
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center gap-4">
        <Link href="/dotadmin/budget-pick" className="text-black hover:text-[#3b82f6] flex items-center justify-center p-2 border-[3px] border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:-translate-x-1 rounded-none">
        ...
        <h1 className="text-3xl font-black uppercase tracking-tight text-black">Add Budget Pick Package</h1>
      </div>
