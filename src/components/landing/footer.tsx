...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-white text-gray-900 pt-20 pb-10 font-sans border-t-[8px] border-[#0066FF]">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Newsletter Section */}
        <div className="flex flex-col lg:flex-row items-center justify-between border-b border-gray-200 pb-16 mb-16 gap-10">
          <div className="max-w-xl">
            <h3 className="text-2xl sm:text-3xl font-black uppercase tracking-tight mb-3">
              Join the <span className="bg-gradient-to-r from-[#00B4DB] to-[#0000FF] bg-clip-text text-transparent">CodeGrid</span> Community
            </h3>
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
              Subscribe to our newsletter for exclusive drops, early access to sales, and insider content. Unsubscribe at any time.
            </p>
          </div>
          <div className="w-full lg:w-auto flex-1 max-w-lg">
            <form className="flex flex-col sm:flex-row w-full gap-3 sm:gap-0">
              <input 
                type="email" 
                placeholder="ENTER YOUR EMAIL ADDRESS"
                className="w-full bg-gray-50 border border-gray-300 px-6 py-4 text-sm focus:outline-none focus:border-[#0066FF] text-gray-900 placeholder-gray-400 rounded-none transition-colors"
                required
              />
              <button 
                type="submit" 
                className="w-full sm:w-auto bg-gradient-to-r from-[#00B4DB] to-[#0000FF] hover:from-[#009bc0] hover:to-[#0000cc] text-white px-8 py-4 font-bold text-sm uppercase tracking-widest transition-colors rounded-none flex items-center justify-center gap-2 border-none"
              >
