        ...
        <div className="grid pt-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4 mt-6">
              <a href="https://www.facebook.com/codegridbd" target='_blank' className="text-gray-400 hover:text-black transition-colors">
              ...
              <a href="https://www.instagram.com/codegridbd" target='_blank' className="text-gray-400 hover:text-black transition-colors">
